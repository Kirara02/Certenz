...
/// @nodoc
abstract class _$$CertificateFailedImplCopyWith<$Res> {
  factory _$$CertificateFailedImplCopyWith(_$CertificateFailedImpl value,
          $Res Function(_$CertificateFailedImpl) then) =
      __$$CertificateFailedImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$CertificateFailedImplCopyWithImpl<$Res>
    extends _$NetworkExceptionsCopyWithImpl<$Res, _$CertificateFailedImpl>
    implements _$$CertificateFailedImplCopyWith<$Res> {
  __$$CertificateFailedImplCopyWithImpl(_$CertificateFailedImpl _value,
      $Res Function(_$CertificateFailedImpl) _then)
      : super(_value, _then);
}

/// @nodoc

class _$CertificateFailedImpl implements CertificateFailed {
  const _$CertificateFailedImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$CertificateFailedImpl);
  }
...
abstract class CertificateFailed implements NetworkExceptions {
  const factory CertificateFailed() = _$CertificateFailedImpl;
}
...
class _$UnprocessableEntityImpl implements UnprocessableEntity {
  const _$UnprocessableEntityImpl(this.reasons);
